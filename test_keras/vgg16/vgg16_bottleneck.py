...
top_model_weights_path = 'vgg16_fc_model.h5'
...
batch_size = 16
bft_file = 'vgg16_bottleneck_features_train.npy'
bfv_file = 'vgg16_bottleneck_features_validation.npy'
...
def predict_bottleneck(image_path):
